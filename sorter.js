...
function showResult() {
  ...
  var i;
  str +=
    '<h3>your NEXAS oshis ranked!</h3><table style="width:450px; font-size:18px; line-height:120%; margin-left:auto; margin-right:auto; border:1px solid #000; border-collapse:collapse" align="center">';
  str +=
    '<tr><td style="text-align:center;">Rank</td><td style="text-align:center;">NEXAN</td></tr>';
  for (i = 0; i < namMember.length; i++) {
